...
**In progress:** 17 submission history and submitted-state UI — local exit gate passed; Preview deployment and authenticated verification pending
**Next:** Ship and verify Phase 17 Preview
**Blockers:** None
